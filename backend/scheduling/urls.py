...
urlpatterns = [
    ...
    path("schedules/<int:pk>/export/", views.ScheduleExportView.as_view()),
    path("schedules/<int:pk>/import/", views.ScheduleImportView.as_view()),
    path("schedules/<int:pk>/publish/", views.SchedulePublishView.as_view()),
